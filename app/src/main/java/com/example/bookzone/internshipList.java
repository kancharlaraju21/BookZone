...
public class internshipList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.activity_internship_list, container, false);
    ...
    class MyAdapter extends ArrayAdapter<String>{
        ...
        MyAdapter(Context c, String title[], String subti[],String sl[]){
            super(c,R.layout.row_internship,R.id.listView2,title);
            this.context=c;
            this.mTitle=title;
            this.sTitle=subti;
            this.sLinks=sl;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View row=layoutInflater.inflate(R.layout.row_internship,parent,false);
